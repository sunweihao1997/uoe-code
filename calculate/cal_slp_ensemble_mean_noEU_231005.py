...
ref_file  = xr.open_dataset(path0 + 'noEU_SLP_1850_150years_member_1.nc')
#print(ref_file)
...
for i in range(8):
    f0 = xr.open_dataset(path0 + 'noEU_SLP_1850_150years_member_' + str(i + 1) +'.nc')
...
ncfile.to_netcdf("/exports/csce/datastore/geos/users/s2618078/data/analysis_data/noEU_SLP_ensemble_mean_231005.nc", format='NETCDF4')
