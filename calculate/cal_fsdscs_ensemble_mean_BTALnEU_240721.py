...
ref_file  = xr.open_dataset(path0 + 'BTALnEU_FSDSCS_1850_150years_member_1.nc')
#print(ref_file)
...
for i in range(8):
    f0 = xr.open_dataset(path0 + 'BTALnEU_FSDSCS_1850_150years_member_' + str(i + 1) +'.nc')
...
ncfile.to_netcdf("/exports/csce/datastore/geos/users/s2618078/data/analysis_data/BTALnEU_FSDSCS_ensemble_mean_240721.nc", format='NETCDF4')
