...
file0 = xr.open_dataset('/home/sun/data/download_data/data/analysis_data/analysis_EU_aerosol_climate_effect/noEU_SLP_ensemble_mean_231005.nc')
print(file0.time)
...
ncfile.attrs['description']  =  'Created on 2024-12-11 by /home/sun/uoe-code/calculate/cal_jja_slp_each_year_BTALnEU_241211.py. This file is the JJA ensemble mean among the 8 member in the BTAL emission experiments. The variables is SLP. This file is the modified type for the noEU_SLP_jja_mean_231005.nc'
ncfile.to_netcdf("/home/sun/data/download_data/data/analysis_data/analysis_EU_aerosol_climate_effect/noEU_SLP_jja_mean_241211.nc", format='NETCDF4')