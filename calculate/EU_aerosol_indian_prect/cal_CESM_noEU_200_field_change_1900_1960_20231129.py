...
file_z   = 'CESM_BTALnEU_JJAS_Z3_ensemble.nc'
file_v   = 'CESM_BTALnEU_JJAS_V_ensemble.nc'
file_u   = 'CESM_BTALnEU_JJAS_U_ensemble.nc'
file_w   = 'CESM_BTALnEU_JJAS_OMEGA_ensemble.nc'
...
def cal_period_diff(ncfile, varname, period, level):
    ...
    return (np.average(ncfile_A[varname], axis=0) - np.average(ncfile_B[varname], axis=0))
...
def calculation():
    ...
    ncfile.to_netcdf(out_path + 'EUI_CESM_diff_BTALnEU_1900_1960_200hPa_Z_UV_500hPa_Omega.nc')
