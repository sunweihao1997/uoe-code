...
def calculation():
    ...
    ncfile.attrs['description'] = 'UVZ and DIVERGENCEat 200 hPa, ttest for the period 1945-1960'
    ...
    ncfile.to_netcdf(out_path + 'EUI_CESM_BTAL_BTALnEU_high_level_but_single_level_200_ensemble_mean_UVWZ_DIV_and_ttest.nc')
