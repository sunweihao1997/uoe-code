...
def paint_jjas_diff(sf, v, p, pic_name, left_title):
    ...
    set_cartopy_tick(ax=ax,extent=extent,xticks=np.linspace(0,140,8,dtype=int),yticks=np.linspace(0,80,9,dtype=int),nx=1,ny=1,labelsize=25)
    ...
    ax.set_title('Stream-function', loc='right', fontsize=25)
