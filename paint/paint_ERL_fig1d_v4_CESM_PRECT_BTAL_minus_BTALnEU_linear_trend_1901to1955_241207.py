...
def main():
    ...
    plot_diff_rainfall(diff_data=gaussian_filter(ncfile['JJA_trend'].data * 55 * 86400000, sigma=0.9), left_title='(c)', right_title='CESM_ALL (JJA)', out_path=out_path, pic_name="ERL_fig1d_v4_CESM_prect_BTAL_minus_BTALnEU_JJA_linear_trend_1901to1955.pdf", level=lev0, p=ncfile['JJA_p'].data)
