...
def paint_jjas_diff(sf, u, v, p, pic_name, left_title):
    ...
    im1  =  ax.contourf(lon, lat, sf_d, levels=np.linspace(-2, 2, 11), cmap='coolwarm', alpha=1, extend='both')
...
#    ax.clabel(im2, fontsize=5, inline=True)
    ...
    /home/sun/uoe-code/paint/paint_ERL_fig3c_v5_CESM_TS_BTAL_BTALnEU_Europe_linear_trend_240719.py
...
def main():
    ...
    ncfile_fx   =  xr.open_dataset('/home/sun/data/download_data/data/wave_activity/BTAL_TN2001-Fx.monthly.btal_minus_btalneu_1901_1955_linear_trend_JJA.nc').sel(level=300)
    ncfile_fy   =  xr.open_dataset('/home/sun/data/download_data/data/wave_activity/BTAL_TN2001-Fy.monthly.btal_minus_btalneu_1901_1955_linear_trend_JJA.nc').sel(level=300)
    ncfile_psi  =  xr.open_dataset('/home/sun/data/download_data/data/wave_activity/BTAL_psidev.monthly.btal_minus_btalneu_1901_1955_linear_trend_JJA.nc').sel(level=300)
...
#    sys.exit()
    ...
    paint_jjas_diff((ncfile_psi['psidev'].data*1e-4), (ncfile_fx['Fx'].data)*10000, (ncfile_fy['Fy'].data) *10000, None, "ERL_fig4a_v5_CESM_BTAL_wave_activity_linear_trend_300_vector_legend.pdf", '1901-1955')
    print("Paint Success")
