'''
2023-10-18
This script calculate and paint surface pressure changes between two given periods
'''
import xarray as xr
import numpy as np
import os
...
class calculate_class:
    out_path0 = '/exports/csce/datastore/geos/users/s2618078/data/model_data/PS/'
    member_num = 8
    ...
    ensemble_path0 = '/exports/csce/datastore/geos/users/s2618078/data/model_data/PS/'
    def cal_ensemble(exp_name, var_name):
        ...
        ncfile.attrs['description']  =  'Created on 2023-10-24. This file is the ensemble mean among the 8 member in the {} emission experiments. The variable is {}.'.format(exp_name, var_name)
        ncfile.attrs['script']       =  'paint_BTAL_change_Indian_JJA_sp_231020.py'
    ...
    def cal_jja_mean(file_path, file_name, var_name, exp_name):
        ...
        ncfile  =  xr.Dataset(
            {
                "{}_JJA".format(var_name): (["time", "lat", "lon"], jja_mean),
            },
            coords={
        ...
        ncfile.attrs['description']  =  'Created on 2023-10-20. This file is JJA mean for the {}. Experiment is {}.'.format(var_name, exp_name)
        ncfile.attrs['script']       =  'paint_BTAL_change_Indian_JJA_slp_231020.py'
        ncfile.to_netcdf("/exports/csce/datastore/geos/users/s2618078/data/analysis_data/{}_{}_ensemble_mean_JJA_231020.nc".format(var_name, exp_name), format='NETCDF4')
