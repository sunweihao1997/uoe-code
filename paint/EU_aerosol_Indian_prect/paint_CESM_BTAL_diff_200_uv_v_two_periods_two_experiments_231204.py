...
def paint_jjas_diff(u, v, p):
    ...
    q  =  ax.quiver(lon, lat, u, v, 
        ...
        scale_units='xy', scale=0.08,        # scale是参考矢量，所以取得越大画出来的箭头就越短
    ...
    plt.savefig('/exports/csce/datastore/geos/users/s2618078/paint/analysis_EU_aerosol_climate_effect/circulation/EUI_EU_emission_influence_long-term_trend_200hPa_uv.pdf')
...
def main():
    ...
    u_diff = u_diff_BTAL - u_diff_noEU
    v_diff = v_diff_BTAL - v_diff_noEU

    paint_jjas_diff(u_diff, v_diff, ncfile['p_v'].data)
