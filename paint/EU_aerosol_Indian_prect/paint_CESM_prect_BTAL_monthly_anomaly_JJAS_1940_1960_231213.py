...
for mm in range(6, 10, 1):
    ...
    file_single_m = file0.sel(time=file0.time.dt.month.isin([mm]))
...
plt.savefig('/exports/csce/datastore/geos/users/s2618078/paint/analysis_EU_aerosol_climate_effect/prect/CESM_prect_anomaly_BTAL_JJAS_monthly.pdf', dpi=500)