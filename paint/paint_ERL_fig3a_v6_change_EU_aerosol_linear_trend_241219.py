...
def main():
    ...
    # === 3. Calculate JJA mean === !!Finished!! /home/sun/data/download_data/data/analysis_data/analysis_EU_aerosol_climate_effect/BTAL_BURDENSO4_ensemble_mean_JJA_241219_corrected.nc
    cal_function.cal_jja_mean()

    # === 4. Calculate difference between two given period ===
    file0 = xr.open_dataset('/home/sun/data/download_data/data/analysis_data/analysis_EU_aerosol_climate_effect/BTAL_BURDENSO4_ensemble_mean_JJA_241219_corrected.nc')
...
##
    ...
    ncfile.attrs['description']  =  'Created on 2024-12-19 by /home/sun/uoe-code/paint/paint_ERL_fig3a_v6_change_EU_aerosol_linear_trend_241219.py. This file is the linear trend (1901-1955) JJA ensemble mean among the 8 member in the BTAL emission experiments. The variables are BURDENSO4_JJA. Note!! this is the corrected version of time-axis.'
    ncfile.to_netcdf("/home/sun/data/download_data/data/analysis_data/analysis_EU_aerosol_climate_effect/BTAL_sulfate_column_burden_jja_mean_linear_trend_1901_1955_241219.nc", format='NETCDF4')
    # === 5 Step Succeed ===

    # === 6. painting ===
    file1 = xr.open_dataset('/home/sun/data/download_data/data/analysis_data/analysis_EU_aerosol_climate_effect/BTAL_sulfate_column_burden_jja_mean_linear_trend_1901_1955_241219.nc')
    ...
    plot_diff_slp_wind(diff_slp=1e5*gaussian_filter((psl_con), sigma=1) * 55,left_title='1901-1955 Linear Trend', right_title='CESM_ALL - CESM_noEU', out_path=out_path, pic_name="ERL_fig3a_v6_JJA_BTAL_BTALnEU_SO4_linear_trend.pdf", level=level2, pvalue=psl_p_con)
