...
period1   = slice(1900, 1915)
period2   = slice(1940, 1955)
...
#    plot_diff_slp_wind(diff_slp=data_file["psl_btal_btalneu_diff"],    diff_u=data_file["u_btal_btalneu_diff"], diff_v=data_file["v_btal_btalneu_diff"] , left_title='(a)', right_title='BTAL - BTALnEU', out_path=out_path, pic_name="Aerosol_research_ERL_2a_BTAL_BTALnEU.pdf", p=data_file['psl_btal_btalneu_diffp'], level=level2)
    plot_diff_slp_wind(diff_slp=gaussian_filter((psl_btal_diff - psl_btalneu_diff), sigma=0.5), diff_u=gaussian_filter((u_btal_diff - u_btalneu_diff), sigma=0.5), diff_v=gaussian_filter((v_btal_diff - v_btalneu_diff), sigma=0.5),  left_title='[1941-1955]-[1901-1915]', right_title='CESM_ALL - CESM_noEU', out_path=out_path, pic_name="Aerosol_research_ERL_2a_BTAL_BTALnEU_850wind_19011955.pdf", level=level2)
