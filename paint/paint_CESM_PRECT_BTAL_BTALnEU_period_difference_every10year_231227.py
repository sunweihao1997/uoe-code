...
#    sp  =  ax.contourf(lon, lat, p, levels=[0.1, 1], colors='none', hatches=['..'])
    ...
    ax.add_patch(mpatches.Rectangle(xy=[76, 20], width=11, height=8,
...
data_p1 = data.sel(time=slice(1960, 1970))
data_p2 = data.sel(time=slice(1970, 1980))
...
def main():
    out_path = '/exports/csce/datastore/geos/users/s2618078/paint/analysis_EU_aerosol_climate_effect/prect/'
    plot_diff_rainfall(diff_data=prect_BTAL_JJAS_DIFF, left_title='BTAL', right_title='JJAS', out_path=out_path,          pic_name="Aerosol_research_CESM_prect_BTAL_JJAS_period_difference_1960_1970_231221.pdf")
    plot_diff_rainfall(diff_data=prect_BTALnEU_JJAS_DIFF, left_title='BTALnEU', right_title='JJAS', out_path=out_path, pic_name="Aerosol_research_CESM_prect_BTALnEU_JJAS_period_difference_1960_1970_231221.pdf")
