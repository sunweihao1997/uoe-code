...
#    # Stippling picture
    ...
    # --- title ---
    ax.set_title('(a)', loc='left', fontsize=22.5)
...
def main():
    ...
    paint_trend(lat=lat, lon=lon, diff=diff_precip_JJAS, level=np.linspace(-2.5, 2.5, 11), p=pvalue["pavlue_GPCC_JJAS_periods"], title_name='JJAS', pic_path='/exports/csce/datastore/geos/users/s2618078/paint/analysis_EU_aerosol_climate_effect/ERL/', pic_name="ERL_fig1b_v2_Aerosol_Research_GPCC_PRECT_JJAS_period_diff_1900_1960.pdf")
