...
def main():
    ...
    plot_diff_rainfall(diff_data=prect_BTAL_JJAS_DIFF, left_title='(c)', right_title='CESM_ALL (JJAS)', out_path=out_path, pic_name="ERL_fig1c_CESM_prect_BTAL_JJAS_period_difference_1900_1960_231221.pdf", p=p_value_BTAL)
