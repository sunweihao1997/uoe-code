...
#    sys.exit()
    ...
    paint_jjas_diff(ncfile_psi['psidev'].data*1e-5*55, 55 * (ncfile_fx['Fx'].data) * 1e4, 55 * (ncfile_fy['Fy'].data) * 1e4, None, "ERL_fig4a_v12_CESM_BTAL_wave_activity_linear_trend_300_no_vector_legend.pdf", '1901-1955')
    print("Paint Success")
