...
def main():
    ...
    # ================================== 150 hPa ===========================================
    ncfile  =  xr.open_dataset('/exports/csce/datastore/geos/users/s2618078/data/analysis_data/analysis_EU_aerosol_climate_effect/EUI_CESM_BTAL_BTALnEU_high_level_but_single_level_150_ensemble_mean_UVWZ_DIV_and_ttest_1945_1960.nc').sel(time=slice(1901, 1955))
    ...
    paint_jjas_diff(10*gaussian_filter((u_con - u_neu), sigma=0.5), 10*gaussian_filter((v_con - v_neu), sigma=0.5), 1e8*gaussian_filter((div_con - div_neu), sigma=1), div_p_con, out_name='ERL_fig2c_v2_CESM_BTAL_BTALnEU_150_uv_div_linear_trend.pdf',  left_title="(c)", right_title="150 hPa")
