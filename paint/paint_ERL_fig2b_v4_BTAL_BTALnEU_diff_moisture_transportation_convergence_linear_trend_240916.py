...
#        "mt_vint_BTAL_diff": (["lat", "lon"],    calculate_class.cal_two_periods_trend(merge_array['mt_vint_BTAL_JJAS'].data,    50, 105)[0]),
#        "mt_vint_BTALnEU_diff": (["lat", "lon"], calculate_class.cal_two_periods_trend(merge_array['mt_vint_BTALnEU_JJAS'].data, 50, 105)[0]),
#        "p_value": (["lat", "lon"], calculate_class.cal_two_periods_trend(merge_array['mt_vint_BTAL_JJAS'].data - merge_array['mt_vint_BTALnEU_JJAS'].data, 50, 105)[1]),
#    },
#    coords={
#        "lat":  (["lat"],  ref_file0['lat'].data),
#        "lon":  (["lon"],  ref_file0['lon'].data),
