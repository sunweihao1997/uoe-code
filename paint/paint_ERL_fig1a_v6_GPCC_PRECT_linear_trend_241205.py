...
#    pvalue = xr.open_dataset("/home/sun/data/download_data/data/analysis_data/Aerosol_research_GPCC_JJAS_periods_pvalue.nc")
    ...
    paint_trend(lat=lat, lon=lon, diff=data_p, level=lev0, p=f0['JJA_p'].data, title_name='1901-1955', pic_path='/home/sun/paint/ERL/', pic_name="ERL_fig1a_v5_Aerosol_Research_GPCC_PRECT_JJA_period_linear_trend_1901to1955.pdf")
