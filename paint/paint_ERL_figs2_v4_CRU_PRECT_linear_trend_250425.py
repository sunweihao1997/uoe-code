...
v4: Reference to https://www.notion.so/Points-With-Meeting-with-Massimo-1c1d5b19b11d8024bc2bff0b15f0f374?pvs=4
'''
import xarray as xr
import numpy as np
...
ncfile = xr.open_dataset(out_path + 'Aerosol_Research_CRU_PRECT_JJA_JJAS_average.nc')
print(np.nanmean(ncfile['JJA_PRECT'].data))
...
ncfile.attrs['description'] = 'Created on 2025-4-25.'
#
out_path = '/home/sun/data/download_data/data/analysis_data/'
ncfile.to_netcdf(out_path + 'Aerosol_Research_CRU_PRECT_JJA_Theil_trend_linear_trend_1901to1955.nc')
...
#    # Stippling picture
    ...
    ax.set_title('CRU', loc='right', fontsize=25)
...
f0        = xr.open_dataset(data_path + 'Aerosol_Research_CRU_PRECT_JJA_Theil_trend_linear_trend_1901to1955.nc')
...
#    pvalue = xr.open_dataset("/home/sun/data/download_data/data/analysis_data/Aerosol_research_GPCC_JJAS_periods_pvalue.nc")
    ...
    paint_trend(lat=lat, lon=lon, diff=f0['JJA_trend'].data * 55, level=lev0, p=f0['JJA_p'].data, title_name='1901-1955', pic_path='/home/sun/paint/ERL/', pic_name="ERL_figs2_v4_Aerosol_Research_CRU_PRECT_JJA_period_linear_trend_1901to1955.pdf")
