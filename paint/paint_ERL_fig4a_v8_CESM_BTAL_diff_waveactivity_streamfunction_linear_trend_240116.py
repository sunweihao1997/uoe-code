...
def paint_jjas_diff(sf, u, v, p, pic_name, left_title):
    ...
    level0 = np.array([-2.5, -2, -1.5, -1, -0.8, -0.6, -0.4, -0.2, -0.05, 0.05, 0.2, 0.4, 0.6, 0.8, 1, 1.5, 2, 2.5]) * 10
...
#    sys.exit()
    ...
    paint_jjas_diff(ncfile_psi['psidev'].data*1e-5*55, 55 * (ncfile_fx['Fx'].data) * 1e4, 55 * (ncfile_fy['Fy'].data) * 1e4, None, "ERL_fig4a_v8_CESM_BTAL_wave_activity_linear_trend_300_vector_legend.pdf", '1901-1955')
    print("Paint Success")
