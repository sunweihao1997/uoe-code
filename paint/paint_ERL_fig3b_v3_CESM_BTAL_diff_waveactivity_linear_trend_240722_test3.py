...
def paint_jjas_diff(sf, u, v, p, pic_name, left_title):
    ...
    im1  =  ax.contourf(lon, lat, sf, levels=np.linspace(-5, 5, 11), cmap='coolwarm', alpha=1, extend='both')
...
#    sys.exit()
    ...
    paint_jjas_diff((ncfile_dv['psidev'].data), (ncfile_fx['Fx'].data)*10000, (ncfile_fy['Fy'].data) *10000, None, "ERL_fig3b_v2_CESM_BTAL_wave_activity_linear_trend_200_test4.pdf", '1901-1955')
    print("Paint Success")
