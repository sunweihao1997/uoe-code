...
#    # Stippling picture
    ...
    # --- title ---
    ax.set_title(title_name, loc='left', fontsize=22.5)
    ax.set_title('GPCC', loc='right', fontsize=22.5)
...
periodA_1 = 1901 ; periodA_2 = 1915
periodB_1 = 1936 ; periodB_2 = 1950
...
def main():
    ...
    paint_trend(lat=lat, lon=lon, diff=diff_precip_JJAS, level=np.linspace(-2., 2., 11), p=pvalue["pavlue_GPCC_JJAS_periods"], title_name='1936-1950', pic_path='/exports/csce/datastore/geos/users/s2618078/paint/analysis_EU_aerosol_climate_effect/ERL/', pic_name="ERL_fig1b_v2_Aerosol_Research_GPCC_PRECT_JJAS_period_diff_1901to1920_1936to1955.pdf")
