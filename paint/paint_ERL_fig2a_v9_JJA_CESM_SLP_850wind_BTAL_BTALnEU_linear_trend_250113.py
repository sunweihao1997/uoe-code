...
#    level2    =  np.array([-5, -4.5, -4, -3.5, -3, -2.5, -2, -1.5, -1, -0.5, 0.5, 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 5])
    plot_diff_slp_wind(diff_slp=5.5*gaussian_filter((psl_con - psl_neu), sigma=1), diff_u=(u_con - u_neu)*55, diff_v=(v_con - v_neu)*55,  left_title='(a)', right_title='CESM_ALL - CESM_noEU', out_path=out_path, pic_name="ERL_fig2a_v7_CESM_slp_850wind_diff_JJA_linear_trend_1901to1955.pdf", level=level2)
