...
def main():
    ...
    paint_jjas_diff(1e2*gaussian_filter((u_con - u_neu), sigma=0.5), 1e2*gaussian_filter((v_con - v_neu), sigma=0.5), 1e8*gaussian_filter((w_con - w_neu), sigma=0.5), w_p_con, out_name='ERL_fig2d_v3_CESM_BTAL_BTALnEU_150_divergent_uv_div_linear_trend.pdf',  left_title="(d)", right_title="Divergent Wind", tlat=lat)
