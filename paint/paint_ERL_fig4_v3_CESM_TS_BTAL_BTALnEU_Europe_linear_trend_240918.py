...
psl_btal    = xr.open_dataset(file_path + 'TS_BTAL_ensemble_mean_JJAS_231020.nc')
psl_btalneu = xr.open_dataset(file_path + 'TS_BTALnEU_ensemble_mean_JJAS_231020.nc')
#print(psl_btal)
...
p1 = 1901 ; p2 = 1956
psl_con, psl_p_con = calculate_linear_trend(p1, p2, psl_btal,    'TS_JJAS')
psl_neu, psl_p_neu = calculate_linear_trend(p1, p2, psl_btalneu, 'TS_JJAS')
psl_dif, psl_p_dif = calculate_linear_trend_diff(p1, p2, psl_btal, psl_btalneu, 'TS_JJAS')
